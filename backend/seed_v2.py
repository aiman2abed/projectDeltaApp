...
def seed_full_curriculum():
    ...
    lessons = [
        ...
        models.Lesson(
            ...
            content_math=r"p + n \Rightarrow \text{address} + (n \cdot \text{sizeof}(*p))",
            video_url="https://www.youtube.com/embed/dQw4w9WgXcQ",
        ...
        models.Lesson(
            ...
            content_math=r"\text{Offset} \bmod{\text{Alignment}} = 0",
            video_url="https://www.youtube.com/embed/dQw4w9WgXcQ",
        ...
        models.Lesson(
            ...
            content_math=r"\text{Memory Read} \neq \text{Cached Value}",
            video_url="https://www.youtube.com/embed/dQw4w9WgXcQ",
        ...
        models.Lesson(
            ...
            content_math=r"\text{malloc}(size\_t) \rightarrow \text{void*}",
            video_url="https://www.youtube.com/embed/dQw4w9WgXcQ",
        ...
        models.Lesson(
            ...
            content_math=r"\text{Ideal CPI} = 1",
            video_url="https://www.youtube.com/embed/dQw4w9WgXcQ",
        ...
        models.Lesson(
            ...
            content_math=r"\frac{EX}{MEM.RegisterRd} = \frac{ID}{EX.RegisterRs}",
            video_url="https://www.youtube.com/embed/dQw4w9WgXcQ",
        ...
        models.Lesson(
            ...
            content_math=r"\text{Stall Penalty} = \text{Cycles to Resolve Branch}",
            video_url="https://www.youtube.com/embed/dQw4w9WgXcQ",
        ...
        models.Lesson(
            ...
            content_math=r"\text{Index} = \text{Address} \pmod{\text{Sets}}",
            video_url="https://www.youtube.com/embed/dQw4w9WgXcQ",
        ...
        models.Lesson(
            ...
            content_math=r"\text{Performance} = \frac{1}{\text{Execution Time}}",
            video_url="https://www.youtube.com/embed/dQw4w9WgXcQ",
